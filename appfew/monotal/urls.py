...
urlpatterns = [
    ...
    path('community/boards/', views.BoardListView.as_view(), name='board_list'),
    path('community/boards/create/', views.BoardCreateView.as_view(), name='board_create'),
    path('community/boards/<int:pk>/', views.BoardDetailView.as_view(), name='board_detail'),
    path('community/messages/<int:pk>/delete/', views.DeleteMessageView.as_view(), name='message_delete'),
    path('community/boards/create/', views.BoardCreateView.as_view(), name='board_create'),
    path('community/boards/<int:pk>/', views.BoardDetailView.as_view(), name='board_detail'),
    path('community/messages/<int:pk>/delete/', views.DeleteMessageView.as_view(), name='message_delete'),
